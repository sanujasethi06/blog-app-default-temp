        ...
        <img src={logo} alt="" className='w-full' />
            ...
            <div className={"absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show "+ (searchVisibility ? "show":"hide")}>
                ...
                <div className="flex items-center gap-3 md:gap-6 ml-auto">
                  <button className="md:hidden bg-grey w-12 h-12 rounded-full flex items-center justify-center" onClick={()=>{setSearchVisibility(current=>!current)}}>
                    <i className="fi fi-rr-search tecy-xl"></i>
                    </button>
                    ...
                    </Link>
                    {
                      ...
                      <Link to={"/dashboard/notification"}>
                        <button className='w-12 h-12 rounded-full bg-grey relative hover:bg-black/10'>
                          <i className="fi-rr-bell text-2xl block mt-1"></i>
                        </button>
                      </Link>
